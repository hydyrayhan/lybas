...
function Dress() {
  ...
  return (
    <div className='dress-page container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
      <Breadcrumb />
      <div className="dress-page-container flex justify-between">
        <div className="dress-page_left w-4/5 mr-[30px]">
          <div className='flex'>
            <div className="dress-page_left_image w-1/2 flex mr-[30px]">
            ...
            <div className="dress-page_left_content w-1/2 mt-[10px]">
              <h1 className="dress-page_left_content_name text-3xl font-semibold">Nike Sportswear Futura Luxe</h1>
              <div className="dress-page_left_content_prices my-[10px] flex items-center">
                ...
                <div className="stock ml-[20px] flex items-center">
                  <svg className='mr-[10px]' width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_418_21362)">
                      <path d="M10.8975 19.625C5.37152 19.625 0.918213 15.3125 0.918213 10C0.918213 4.6875 5.37152 0.40625 10.8975 0.40625C16.4235 0.40625 20.9093 4.6875 20.9093 10C20.9093 15.3125 16.4235 19.625 10.8975 19.625ZM10.8975 1.5C6.02164 1.5 2.05592 5.3125 2.05592 10C2.05592 14.6875 6.02164 18.5313 10.8975 18.5313C15.7734 18.5313 19.7716 14.6875 19.7716 10C19.7716 5.3125 15.7734 1.5 10.8975 1.5Z" fill="#1A54EB" />
                      <path d="M9.7923 12.1875C9.56476 12.1875 9.36972 12.125 9.17469 11.9687L7.0293 9.96875C6.80176 9.75 6.80176 9.40625 7.0293 9.1875C7.25684 8.96875 7.6144 8.96875 7.84195 9.1875L9.7923 11.0312L13.953 7.15625C14.1806 6.9375 14.5382 6.9375 14.7657 7.15625C14.9932 7.375 14.9932 7.71875 14.7657 7.9375L10.4424 12C10.2149 12.125 9.98733 12.1875 9.7923 12.1875Z" fill="#1A54EB" />
                    </g>
                    <defs>
              ...
              <div className="dress-page_left_content_fabrics flex mb-[15px]">
                <button className="dress-page_left_content_fabrics_fabric  mr-[12px] py-[6px] px-[12px] rounded-lg border border-lybas-blue text-lybas-blue">Pombarh</button>
              </div>
              <div className="dress-page_left_content_size-name text-sm text-lybas-gray mb-[10px]">{t('size')}:</div>
              <div className="dress-page_left_content_sizes flex items-center mb-[15px]">
                <button className="dress-page_left_content_sizes_size mr-[12px] py-[6px] px-[12px] rounded-lg border border-lybas-light-gray">M(38)</button>
                <button className="dress-page_left_content_sizes_size mr-[12px] py-[6px] px-[12px] rounded-lg border border-lybas-light-gray">M(38)</button>
                <button className="dress-page_left_content_sizes_size mr-[12px] py-[6px] px-[12px] rounded-lg border border-lybas-blue text-lybas-blue">M(38)</button>
                <button className="dress-page_left_content_sizes_size mr-[12px] py-[6px] px-[12px] rounded-lg border border-lybas-light-gray">M(38)</button>
                <button className="dress-page_left_content_sizes_size mr-[12px] py-[6px] px-[12px] rounded-lg border border-lybas-light-gray">M(38)</button>
              </div>
              ...
              <div className="dress-page_left_content_devider w-full h-[2px] bg-lybas-light-gray my-[20px]"></div>
              <div className="dress-page_left_content _definition">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Soluta maiores nulla pariatur ducimus eaque et culpa! Quam veniam esse reprehenderit, accusantium corrupti fugiat magnam doloremque facilis cupiditate. Optio, architecto accusantium?</div>
            </div>
          </div>
          <div className="dress-page_left_devider w-full h-[2px] bg-lybas-light-gray my-[20px]"></div>
          <div className="dress-page_left_comments w-full">
            ...
            <div className="dress-page_left_comments_comment flex items-start p-[25px] mb-[15px] bg-lybas-light-gray rounded-lg">
              <div className="dress-page_left_comments_comment_image mr-[15px]"><img src={image1} alt="" className='min-w-[60px] min-h-[60px] max-h-[60px] rounded-full' /></div>
              <div className="dress-page_left_comments_comment_content">
                ...
                <div className="dress-page_left_comments_comment_content_definition mb-[10px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem ullam praesentium tempore, commodi excepturi quas?</div>
                <div className="dress-page_left_comments_comment_content_connects flex items-center">
                  ...
                  <img src={image1} alt="" className='h-[48px] w-[48px] mr-[8px] rounded' />
                  <img src={image1} alt="" className='h-[48px] w-[48px] mr-[8px] rounded' />
                  <div className="more h-[48px] w-[48px] mr-[8px] rounded flex items-center justify-center bg-lybas-gray text-white"><span>+5</span></div>
                </div>
              </div>
              <div className="dress-page_left_comments_comment_time min-w-fit">2 hours ago</div>
            </div>
            <div className="dress-page_left_comments_comment flex items-start p-[25px] mb-[15px] bg-lybas-light-gray rounded-lg">
              <div className="dress-page_left_comments_comment_image mr-[15px]"><img src={image1} alt="" className='min-w-[60px] min-h-[60px] max-h-[60px] rounded-full' /></div>
              <div className="dress-page_left_comments_comment_content">
          ...
          <div className="dress-page_left_similar-dresses">
            ...
            <div className="dress-page_left_similar-dresses_dresses grid grid-cols-4 gap-4">
        ...
        <div className="dress-page_right w-1/5">
          ...
          <div className="dress-page_right_add-card p-[20px] mb-[20px] rounded-lg shadow-lybas-1">
            ...
            <div className="dress-page_right_add-card_number my-[15px] flex justify-between items-center">
              <span className='text-lybas-gray'>{t("numbers")}:</span>
              <div className="buttons shadow-lybas-1 h-[32px] flex items-center rounded-lg">
                <button className='h-full px-[8px] group'>
            ...
            <button className='dress-page_right_add-card_order-button w-full py-[10px] mb-[15px] bg-lybas-blue rounded-lg text-white'>{t('order')}</button>
            <button className='dress-page_right_add-checkout-button w-full py-[10px] shadow-lybas-1 text-lybas-blue rounded-lg'>{t('checkout')}</button>
          </div>
          <div className="dress-page_right_seller-card p-[20px] mb-[20px] rounded-lg shadow-lybas-1">
            ...
            <div className="dress-page_right_seller-card_location flex">
              <svg className='mr-4' width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                <span>Kümuş.G</span>
                <span>105 Types of dresses</span>
              </div>
            </div>
            <div className="dress-page_right_seller-card_velayat">
            ...
            <button className='dress-page_right_seller-card_more-button'>{t('more')}</button>
            <button className='dress-page_right_seller-card_remind-button'>{t('remindMe')}</button>
          </div>
        </div>
      </div>
    </div>
