...
function Account() {
  ...
  const renderContent = (content) => {
    if (content === 'myAccount') {
      ...
      return (
        <div className="account_card_order col-span-2 p-5">
          <div className="w-full account_card_order_list rounded-lg border mb-5">
            <div className="account_card_order_list_top grid grid-cols-6 gap-4 px-5 py-2 flex items-center border-b">
              ...
              <div className="account_card_order_list_top_col flex justify-center items-center">
                <button className={'rounded-lg text-white py-2 px-2 bg-lybas-blue ' + 'opacity-75'} disabled={true}>
                  {t('buyAgain')}
                </button>
              </div>
