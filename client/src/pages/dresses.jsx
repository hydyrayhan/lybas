  ...
  return (
    <div className='dresses container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
      ...
      <div className="dresses_main flex justify-between">
        <div className="dresses_main_left w-0 md:w-2/5">
          <SellerBox />
          <Sidebar />
        </div>
        <div className="dresses_right w-full md:w-3/5 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:ml-5 lg:ml-[30px]">
          <Dress hover='on_sale' />
          <Dress hover='on_sale' />
          <Dress hover='on_sale' />
          <Dress hover='on_sale' />
