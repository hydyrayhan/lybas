  ...
  return (
    <div className='dressmaker container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
      ...
      <div className="dressmaker_header rounded-lg h-[125px] p-3 mb-5 flex">
        <img className='dressmaker_header_image rounded-lg h-[100px] w-[100px] mr-5 object-cover' src={require('../assets/images/dressImage.png')} alt="" />
        <div className="dressmaker_header_content h-full flex flex-col justify-center">
          <h1 className='text-[30px] font-bold'>Kumush.G</h1>
          <div className="location flex items-center">
            ...
            <span className='font-bold'>Ashgabat</span>
          </div>
        </div>
