        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <Link to="/sellerProfile" className="flex ml-2 md:mr-24">
            ...
            <div className="search w-full max-w-lg flex items-center">
              <form className="w-full px-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full py-2 pl-12 pr-4 text-gray-500 rounded-lg outline-none focus:bg-white focus:border-indigo-600 bg-lybas-light-blue border"
                  />
                </div>
              </form>
            </div>
        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white light:bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li className='sidebar_link'>
              <Link to={'/sellerProfile'} className={"flex items-center p-2 pl-4 text-gray-900 rounded-lg light:text-white hover:bg-gray-100 light:hover:bg-gray-700 group " + (active === 0 ? 'active' : '')}>
            ...
            <li className='sidebar_link group'>
              <Link to={'/sellerProfile/orders'} className={"flex items-center p-2 pl-4 text-gray-900 rounded-lg light:text-white hover:bg-gray-100 light:hover:bg-gray-700 group border-l-[7px] border-l-white group-hover:border-gray-100 group-hover:border-l-gray-100" + (active === 1 ? 'active' : '')}>
                <svg className='flex-shrink-0 w-5 h-5 fill-gray-500 transition duration-75 light:fill-gray-400 group-hover:fill-gray-900 light:group-hover:fill-white' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className='sidebar_link group'>
              <Link to={'/sellerProfile/users'} className={"flex items-center p-2 pl-4 text-gray-900 rounded-lg light:text-white hover:bg-gray-100 light:hover:bg-gray-700 group border-l-[7px] border-l-white group-hover:border-gray-100 group-hover:border-l-gray-100" + (active === 2 ? 'active' : '')}>
                <svg className='flex-shrink-0 w-5 h-5 fill-gray-500 transition duration-75 light:fill-gray-400 group-hover:fill-gray-900 light:group-hover:fill-white' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g >
                    <path d="M1.01667 11.5168C1.74157 10.7919 2.72474 10.3846 3.74991 10.3846H9.7499C10.7751 10.3846 11.7582 10.7919 12.4831 11.5168C13.208 12.2417 13.6153 13.2248 13.6153 14.25V15.75C13.6153 16.2279 13.2278 16.6154 12.7499 16.6154C12.272 16.6154 11.8845 16.2279 11.8845 15.75V14.25C11.8845 13.6839 11.6596 13.1409 11.2593 12.7406C10.859 12.3403 10.316 12.1154 9.7499 12.1154H3.74991C3.18377 12.1154 2.64082 12.3403 2.2405 12.7406C1.84019 13.1409 1.61529 13.6839 1.61529 14.25V15.75C1.61529 16.2279 1.22784 16.6154 0.749906 16.6154C0.271967 16.6154 -0.115479 16.2279 -0.115479 15.75V14.25C-0.115479 13.2248 0.291766 12.2417 1.01667 11.5168Z" />
                    <path d="M6.74991 3.11538C5.57099 3.11538 4.61529 4.07108 4.61529 5.25C4.61529 6.42891 5.57099 7.38461 6.74991 7.38461C7.92882 7.38461 8.88452 6.42891 8.88452 5.25C8.88452 4.07108 7.92882 3.11538 6.74991 3.11538ZM2.88452 5.25C2.88452 3.1152 4.61511 1.38461 6.74991 1.38461C8.8847 1.38461 10.6153 3.1152 10.6153 5.25C10.6153 7.38479 8.8847 9.11538 6.74991 9.11538C4.61511 9.11538 2.88452 7.38479 2.88452 5.25Z" />
                    <path d="M14.1622 11.1312C14.2817 10.6684 14.7537 10.3901 15.2165 10.5096C16.0457 10.7237 16.7804 11.2072 17.3051 11.884C17.8298 12.5609 18.1149 13.3929 18.1155 14.2494V15.75C18.1155 16.2279 17.7281 16.6154 17.2501 16.6154C16.7722 16.6154 16.3847 16.2279 16.3847 15.75V14.2502C16.3843 13.7774 16.2269 13.3181 15.9372 12.9444C15.6474 12.5706 15.2417 12.3036 14.7838 12.1854C14.321 12.0659 14.0427 11.5939 14.1622 11.1312Z" />
                    <path d="M11.1618 2.13285C11.2803 1.66984 11.7518 1.39061 12.2148 1.50915C13.0462 1.72204 13.7832 2.2056 14.3095 2.8836C14.8357 3.5616 15.1214 4.39547 15.1214 5.25375C15.1214 6.11203 14.8357 6.9459 14.3095 7.62389C13.7832 8.30189 13.0462 8.78545 12.2148 8.99834C11.7518 9.11688 11.2803 8.83765 11.1618 8.37465C11.0432 7.91164 11.3225 7.4402 11.7855 7.32165C12.2446 7.20409 12.6516 6.93705 12.9422 6.56263C13.2329 6.18822 13.3906 5.72772 13.3906 5.25375C13.3906 4.77977 13.2329 4.31928 12.9422 3.94486C12.6516 3.57044 12.2446 3.3034 11.7855 3.18584C11.3225 3.06729 11.0432 2.59585 11.1618 2.13285Z" />
                  </g>
                  <defs>
                    <clipPath id="clip0_700_8585">
                ...
                <span className="ml-3 text-lybas-gray group-hover:text-gray-900">{t("users")}</span>
              </Link>
            </li>
            <li className='sidebar_link group'>
              <Link to={'/sellerProfile/dresses'} className={"flex items-center p-2 pl-4 text-gray-900 rounded-lg light:text-white hover:bg-gray-100 light:hover:bg-gray-700 group border-l-[7px] border-l-white group-hover:border-gray-100 group-hover:border-l-gray-100" + (active === 3 ? 'active' : '')}>
                <svg className='flex-shrink-0 w-5 h-5 fill-gray-500 transition duration-75 light:fill-gray-400 group-hover:fill-gray-900 light:group-hover:fill-white' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className='sidebar_link group'>
              <Link to={'/sellerProfile/comments'} className={"flex items-center p-2 pl-4 text-gray-900 rounded-lg light:text-white hover:bg-gray-100 light:hover:bg-gray-700 group border-l-[7px] border-l-white group-hover:border-gray-100 group-hover:border-l-gray-100" + (active === 3 ? 'active' : '')}>
                <svg className='flex-shrink-0 w-5 h-5 fill-gray-500 transition duration-75 light:fill-gray-400 group-hover:fill-gray-900 light:group-hover:fill-white' width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
