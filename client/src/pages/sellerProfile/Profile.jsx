      ...
      <div className="one-comment_content flex mt-5">
        <div className="one-comment_content_left bg-white rounded-lg w-3/5 mr-5">
          ...
          <div className="inputs grid grid-cols-4 gap-5 p-5">
            ...
            <div className="dress-input col-span-4 cursor-pointer">
              <label className="label font-semibold block mb-2.5" htmlFor='name-tm'>{t('province')}</label>
              <button onClick={() => (setChangePasswordPopup(true))} className="profile-input block w-full text-lybas-gray bg-gray-100 rounded-lg flex items-center pr-5">
                <input type="password" value={'jkfjd'} disabled className='w-full cursor-pointer text-lybas-gray bg-gray-100 rounded-lg outline-none px-5 py-2.5' placeholder={t('nameTm')} id='name-tm' />
