...
function Comment() {
  ...
  return (
    <div className="dress-page_left_comments_comment flex flex-col md:flex-row items-start p-3 md:p-[25px] mb-[15px] bg-lybas-light-gray rounded-lg">
      <div className='flex'>
        ...
        <div className="dress-page_left_comments_comment_content">
          ...
          <div ref={littleImagesRef} className="dress-page_left_comments_comment_content_connects flex items-center">
            <img src={image1} onClick={() => setGalleryOpen(true)} alt="" className="h-[48px] w-[48px] mr-[8px] rounded" />
            <img src={image1} onClick={() => setGalleryOpen(true)} alt="" className="h-[48px] w-[48px] mr-[8px] rounded" />
            <img src={image1} onClick={() => setGalleryOpen(true)} alt="" className="h-[48px] w-[48px] mr-[8px] rounded" />
          ...
          {/* Image show like gallery */}
          {
            ...
            <div className='gallery-container w-full h-full fixed z-10 top-0 left-0 bg-[#5d5c5c61] flex items-center justify-center'>
              <div ref={galleryRef} className="gallery-container_image-container w-full md:w-3/5 lg:w-2/5 bg-white flex flex-col items-end rounded-lg overflow-hidden p-5">
                ...
                <img className='w-full rounded-lg' src={require('../assets/images/dressImage.png')} alt="" />
                <div className="gallery-container_small-images flex flex-wrap w-full">
                  <img className='w-[48px] h-[48px] object-cover rounded-lg mr-2 mt-2 cursor-pointer opacity-60' src={require('../assets/images/dressImage.png')} alt="" />
                  <img className='w-[48px] h-[48px] object-cover rounded-lg mr-2 mt-2 cursor-pointer' src={require('../assets/images/dressImage.png')} alt="" />
                  <img className='w-[48px] h-[48px] object-cover rounded-lg mr-2 mt-2 cursor-pointer' src={require('../assets/images/dressImage.png')} alt="" />
                  <img className='w-[48px] h-[48px] object-cover rounded-lg mr-2 mt-2 cursor-pointer' src={require('../assets/images/leftSmallImage.png')} alt="" />
                </div>
              </div>
            </div>
          }
      ...
      <div className="dress-page_left_comments_comment_time md:min-w-fit text-right mt-4 md:mt-0">2 hours ago</div>
    </div>
  );
}
