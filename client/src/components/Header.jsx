            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <button onClick={()=>dispatch(setCartDropdown(true))} className="text-sm font-medium text-gray-700 hover:text-gray-800">
                  ...
                  <button onClick={()=>setOpenUserPopup(true)} className="text-sm font-medium text-gray-700 hover:text-gray-800">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
