...
function Dress({ hover }) {
  ...
  const size_style = {
    recommended: {
      ...
      discount: 'hidden',
      go_link_hover: 'dress-card_custom-buttons_link flex items-center mb-4 md:mb-0',
      like: 'hidden',
      discount_top: 'hidden',
    ...
    most_popular: {
      ...
      go_link_hover: 'dress-card_custom-buttons_link flex items-center transition-opacity duration-300 md:opacity-0 group-hover:opacity-[1] mb-2',
    ...
    on_sale: {
      ...
      location: 'dress-card_rate_city flex items-center text-lybas-gray text-sm',
      discount: 'mt-2 text-lybas-red line-through',
      go_link_hover: 'dress-card_custom-buttons_link flex items-center transition-opacity duration-300 md:opacity-0 group-hover:opacity-[1]',
      like: 'absolute z-10 top-[5px] bg-black right-[5px] p-[5px] rounded',
      discount_top: 'absolute z-10 top-[5px] left-[5px] bg-lybas-red text-white rounded py-[7px] px-[12px] text-sm',
    ...
    <div className='dress-card group relative'>
      <Link to={'/dresses/1'}>
        ...
        <div className="dress-card_rate flex flex-col lg:flex-row lg:items-center">
          ...
          <span className={size_style[hover].location}><span className='dress-card_rate_city_dot hidden md:block w-[5px] h-[5px] bg-lybas-gray block rounded mr-1'></span>Ashgabat</span>
        </div>
      </Link>
