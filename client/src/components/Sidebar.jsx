...
const Sidebar = () => {
  ...
  return (
    <div className='sidebar py-5 fixed max-h-[80%] z-[100] bg-white left-0 right-0 bottom-0 md:relative container md:mx-0 min-w-full mx-auto px-6 md:px-0'>
      <div className='sidebar_mobile-top w-full flex md:hidden justify-center mb-5'><span className='h-2 w-10 bg-gray-500 rounded-full flex justify-center'></span></div>
      <div className='p-5 max-h-auto md:max-h-auto overflow-auto w-full md:w-auto'>
