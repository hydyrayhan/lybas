        ...
        <div className="mx-auto max-w-full lg:max-w-7xl">
          <div className="group relative">
            <div className="overflow-hidden relative">
              ...
              <button onClick={()=>navigate('/dressmakers/1')} className='dressmaker-more-button hidden md:flex justify-between items-center py-[6px] px-[16px] bg-lybas-blue text-white rounded absolute bottom-[10px] right-[10px] transition-opacity duration-300 md:opacity-0 group-hover:opacity-[1]'>
            ...
            <button onClick={()=>navigate('/dressmakers/1')} className='dressmaker-more-button w-full flex md:hidden justify-center items-center py-[6px] px-[16px] mt-2 bg-lybas-blue text-white rounded'>
              <svg className='mr-[16px]' width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.4 13L0 11.6L9.6 2H1V0H13V12H11V3.4L1.4 13Z" fill="white" />
              </svg>
              <span className='text-base'>{t('more')}</span>
