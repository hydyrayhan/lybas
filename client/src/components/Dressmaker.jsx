        ...
        <div className="mx-auto max-w-full lg:max-w-7xl">
          <div className="group relative">
            <div className="overflow-hidden relative">
              <img src={image1} alt="" className='h-full w-full object-cover object-center lg:h-full lg:w-full rounded-t-lg group-hover:opacity-75 lg:h-80' style={{ border: '1.5px solid rgba(100, 116, 139, 0.1)' }} />
              <button className='dressmaker-more-button flex justify-between items-center py-[6px] px-[16px] bg-lybas-blue text-white rounded absolute bottom-[10px] right-[10px] transition-opacity duration-300 opacity-0 group-hover:opacity-[1]'>
