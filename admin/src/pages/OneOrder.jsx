                      ...
                      <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <td scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white flex items-center">
                          ...
                          <div className='flex flex-col justify-center'>
                            <div className='font-bold mb-1'>{product.product['name_' + lang]}</div>
                            <div className='text-sm text-gray-500'>{product.material['name_' + lang]} <span className='mr-2'></span> {product.size} <span className='mr-2'></span> {product.price.toFixed(2)}</div>
                          </div>
                        </td>
