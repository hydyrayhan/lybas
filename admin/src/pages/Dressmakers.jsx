...
function Dressmakers() {
  ...
  return (
    <div className='dresses'>
      <Search title='dressmaker' className='mt-5' action={{ link: '/dressmakers/add', text: 'addDressmaker' }} setDate={setFilterData} setSearch={setSearchData} setWelayat={setWelayatData} filter={[{ text: 'ashgabat' }, { text: 'ahal' }, { text: 'balkan' }, { text: 'dashoguz' }, { text: 'lebap' }]} />
