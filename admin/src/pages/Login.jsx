      ...
      <div className='login w-4/5 m-auto translate-y-1/2 flex'>
        <div className="login_form w-1/2 p-20 bg-white">
          ...
          <form>
            ...
            <input type="text" id='login' required className='outline-none border w-full py-2 px-4 mb-4 rounded-lg text-lybas-gray' />
            ...
            <div className="input_password pr-3 mb-5 text-lybas-gray flex justify-between items-center border rounded-lg">
              <input type={passwordOpen ? 'text' : 'password'} required className='outline-none py-2 px-4 w-full mr-3 text-lybas-gray' />
